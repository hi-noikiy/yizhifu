...
<head>
  ...
  <title><?=$title?></title>
  <meta name="keywords" content="发卡军,支付接口,免签约API支付接口,自动发卡平台,自动发卡系统,自动发卡网,卡密寄售平台"/>
...
<li><a href="./login.php"><span class="glyphicon glyphicon glyphicon-shopping-cart"></span>   登录</a>
          </li>

           <li> <a href="./reg.php?my=add"><span class="glyphicon glyphicon-cloud"></span>   注册</a>
          </li>
...
<label>结算方式:</label><br><select class="form-control" name="alipay_uid"><option value="QQ钱包">QQ钱包</option><option value="支付宝">支付宝</option></select>
</div>
<div class="form-group">
<label>结算账号:</label><br>
