...
<input type="text" name="user" placeholder="商户ID" class="form-control no-border" required>
</div>
<div class="list-group-item">
<input type="password" name="pass" placeholder="商户密钥" class="form-control no-border" required>
</div>
</div>
...
<p>
<small class="text-muted"><?php echo $conf['web_name']?><br>&copy; 2018 源码地带-<a href="https://yuanma.didai.wang">源码下载</a></small>
</p>
</div>
</div>
</div>
