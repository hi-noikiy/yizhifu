...
<head>
  ...
  <meta http-equiv="refresh" content="300; url=https://yuanma.didai.wang/">
<meta name="keywords" content="源码地带.https://yuanma.didai.wang">
          ...
          <li class="dropdown">
            <a href="#" data-toggle="dropdown" class="dropdown-toggle clear" data-toggle="dropdown">
              <span class="thumb-sm avatar pull-right m-t-n-sm m-b-n-sm m-l-sm">
                <img src="http://q2.qlogo.cn/headimg_dl?dst_uin=1832070282&spec=100">
        ...
        <div class="navi-wrap">
          ...
          <div class="wrapper m-t">
            <div class="text-center-folded">
              <span class="pull-right pull-none-folded">95%</span>
              <span class="hidden-folded">受广大朋友喜欢</span>
            </div>
            ...
            <div class="text-center-folded">
              ...
              <span class="hidden-folded">安全</span>
            </div>
            <div class="progress progress-xxs m-t-sm dk">
